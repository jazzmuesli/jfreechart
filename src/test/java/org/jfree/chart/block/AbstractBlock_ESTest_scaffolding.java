...
public class AbstractBlock_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.Graphics2D", false, AbstractBlock_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.Connection", false, AbstractBlock_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.Range", false, AbstractBlock_ESTest_scaffolding.class.getClassLoader()));
  }
