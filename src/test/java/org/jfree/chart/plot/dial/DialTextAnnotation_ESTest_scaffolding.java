...
public class DialTextAnnotation_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.jfree.chart.plot.dial.DialTextAnnotation"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DialTextAnnotation_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.Graphics2D", false, DialTextAnnotation_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.event.ComponentListener", false, DialTextAnnotation_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DialTextAnnotation_ESTest_scaffolding.class.getClassLoader()); 
